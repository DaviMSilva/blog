export default function About () {
    return (
        <>
            <article className="mb-3 border-b">
                <img className="max-w-28 rounded-full border-gray-400 border-4" src="https://media.licdn.com/dms/image/v2/D4D03AQEC7AgcsYdnVw/profile-displayphoto-shrink_800_800/profile-displayphoto-shrink_800_800/0/1720118331398?e=1736985600&v=beta&t=pTX3pVMDGwi6FpAQTjpMaSHL4q_DrxpomTNj4uUuiac" alt="" />
