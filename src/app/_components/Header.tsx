    ...
    return (
        <header className="w-screen">
            <nav className="flex justify-between items-center mx-auto h-14  max-w-lg">
                <a href="/" className="font-semibold text-xl group">
                    DaviMSilva
                    <div data-is-path={isHome} className="block w-5 bg-blue-400 h-1 group-hover:w-full data-[is-path=true]:w-full  transition-all">
                    </div>
                </a>
